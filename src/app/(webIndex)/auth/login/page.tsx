    ...
    <>
      <Row>
        <Modal>
          ...
          <Col span={8}>
            <Row className='bg-[#1A2A3A] py-[190px] px-[72px] h-full'>
              <div className='w-full'>
                <Text className='text-white text-[60px] font-[700]'>Welcome !</Text>
                <Text className='text-white text-[24px] font-[300]'>
